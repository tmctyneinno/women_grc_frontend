...
<template>
  <nuxt-layout name="landing-layout">
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <!-- Hero Section -->
      <div class="relative overflow-hidden bg-gradient-to-r from-navyblue-500 via-blue-800 to-blue-800">
            ...
            <div class="max-w-2xl mx-auto">
              <div class="relative">
                ...
                <input 
                  ...
                  class="w-full pl-12 pr-4 py-4 rounded-xl bg-black/10 border border-white/20 text-black placeholder:text-black focus:outline-none focus:ring-2 focus:ring-black-400 focus:border-transparent transition-all duration-200"
                />
              </div>
            </div>
          </div>
