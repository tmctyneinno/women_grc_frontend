                  ...
                  <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                      ...
                      <a 
                        ...
                        target="_blank"
                        class="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-800 to-cyan-100 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-1"
                      >
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
                        </svg>
