...
<template>
  <nuxt-layout name="landing-layout">
    ...
    <div v-else-if="event">
      ...
      <section class="relative bg-gradient-to-br from-gray-900 to-black">
        <!-- Navigation Bar -->
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
              ...
              <div v-if="event.is_online && event.meeting_link" class="bg-white rounded-3xl shadow-xl p-8">
                  ...
                  <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                      ...
                      <a 
                        ...
                        target="_blank"
                        class="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-1"
                      >
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
                        </svg>
